...
class Profile(models.Model):
    ...
    bill = models.DecimalField('Счет пользователя в рублях', decimal_places=2, default=0, max_digits=2)
...
class Waste(models.Model):
    ...
    amount = models.DecimalField('Количество потраченных денег', decimal_places=2, max_digits=2)
